...
- `progression_type` defines the type of progression. The value currently available is `SymptomData`. Different progressions can be defined within the same file.
