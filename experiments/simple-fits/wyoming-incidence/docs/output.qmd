...
The relative infectiousness of asymptomatics is assumed to be proportional to the ratio of log viral load between individuals
...
We assume that dividing by the point estimate of the proportion asymptomatic for the alpha variant (0.861, Whitaker et al., 2022) 
...
(0.861, CI: 0.83, 0.89). We increase the variance to account for reasonable differences between UK and US populations, as well as
