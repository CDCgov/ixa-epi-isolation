...
#| fig-width: 6.5
#| fig-height: 6.5
modifed_scenario_data = modifed_scenario_data.join(
    modifed_scenario_data.group_by(["scenario", "Policy Adherence", "Facemask Efficacy"]).agg(
        pl.col("count").max().alias("max_count")
    ),
    on=["scenario", "Policy Adherence", "Facemask Efficacy"]
)
