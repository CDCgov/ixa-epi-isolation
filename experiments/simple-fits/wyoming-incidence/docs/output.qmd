...
A scenario analysis is conducted that studies effects of the update and previous isolation guidance on hospitalizations. The guidances are compared to a counterfactual "No Guidance", which is the context for the model calibration. Two relavent policy parameters are studied in set of scenarios that are enumerated in the following table.
...
sns.catplot(
    ...
    hue="Guidance",
    kind="violin",
    row="Policy Adherence",
    col="Facemask Efficacy",
)
