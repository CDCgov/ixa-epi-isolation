...
# We change this for simplicity to be the repo by backing up four levels.
os.chdir("../../../../")
```
...
experiment = Experiment(
    ...
    config_file="experiments/examples/replicate-core-example/input/config.yaml",
    verbose=False
)
```
...
automatically knows to iterate over that parameter set with the number of replicates we specify in
the config.
