...
echo "Running the simulations for the SIR-like model assuming one person per household..."

poetry run python scripts/call_integration_test.py -f tests/integration/sir_unique_hh/input/config.yaml
