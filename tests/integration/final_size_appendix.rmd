...
The following is based on Brauer et al. 2019. We begin with the standard formulation of the model.
...
xlab = expression(italic(R[0])), ylab = expression(paste("final size, ", italic(Z))))
...
points(x = r0_values[r0_values >= 1], y = herd_immunity_threshold, type = "l", col = "darkgrey", lty = 2)
legend("bottomright",
legend = c(expression(paste("initial size, ", italic(Y=0))),
           ...
           "herd immunity threshold"), lty = c(1,1,1,1,2), col = c("black", "blue", "purple", "red", "darkgrey"))
